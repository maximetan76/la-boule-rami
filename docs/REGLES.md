...
- "Chocolat" : le joueur qui a annoncé "Je joue" (et a donc clos la phase d'annonces) est "chocolat" sur ce coup s'il n'a JAMAIS réussi sa première pose (51 points + tierce pure) à aucun moment du coup, au moment où un autre joueur termine. Son score perdant du coup est alors DOUBLÉ, et ce doublement se cumule avec le friché, le double et le triple (ex : forfait de 100 points × 2 friché × 2 double × 2 chocolat = 800 points). Un joueur qui a posé au moins une fois pendant le coup n'est pas chocolat, même s'il lui reste des cartes en main.
